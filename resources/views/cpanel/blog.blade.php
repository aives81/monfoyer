                                    ...
                                    <ul>
                                        <li>
                                            <div class="row no-gutters">
                                                <div class="col-lg-4 col-md-12 col-sm-12">
                                                    <div class="blog-img">
                                                        <img src="{{asset('assets/vendors/images/img2.jpg')}}" alt=""
                                                             class="bg_img">
                                                    </div>
                                                </div>
                                                <div class="col-lg-8 col-md-12 col-sm-12">
                                                    <div class="blog-caption">
                                                        <h4><a href="#">Lorem ipsum dolor sit amet, consectetur
                                                                adipisicing elit</a></h4>
                                                        <div class="blog-by">
                                        ...
                                        <li>
                                            <div class="row no-gutters">
                                                <div class="col-lg-4 col-md-12 col-sm-12">
                                                    <div class="blog-img">
                                                        <img src="{{asset('assets/vendors/images/img3.jpg')}}" alt=""
                                                             class="bg_img">
                                                    </div>
                                                </div>
                                                <div class="col-lg-8 col-md-12 col-sm-12">
                                        ...
                                        <li>
                                            <div class="row no-gutters">
                                                <div class="col-lg-4 col-md-12 col-sm-12">
                                                    <div class="blog-img">
                                                        <img src="{{asset('assets/vendors/images/img4.jpg')}}" alt=""
                                                             class="bg_img">
                                                    </div>
                                                </div>
                                                <div class="col-lg-8 col-md-12 col-sm-12">
                                        ...
                                        <li>
                                            <div class="row no-gutters">
                                                <div class="col-lg-4 col-md-12 col-sm-12">
                                                    <div class="blog-img">
                                                        <img src="{{asset('assets/vendors/images/img5.jpg')}}" alt=""
                                                             class="bg_img">
                                                    </div>
                                                </div>
                                                <div class="col-lg-8 col-md-12 col-sm-12">
                                ...
                                <div class="card-box mb-30">
                                    ...
                                    <div class="latest-post">
                                        <ul>
                                            ...
                                            <li>
                                                <h4><a href="#">Lorem ipsum dolor sit amet, consectetur adipisicing
                                                        elit</a></h4>
                                                <span>Css</span>
                                            </li>
                                            <li>
