                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-4 col-sm-12 mb-30">
                        <div class="pd-20 card-box height-100-p">
                            ...
                            <a href="#" class="btn-block" data-toggle="modal" data-target="#bd-example-modal-lg"
                               type="button">
                                <img src="{{asset('assets/vendors/images/modal-img1.jpg')}}" alt="modal">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-12 mb-30">
                        <div class="pd-20 card-box height-100-p">
                            ...
                            <a href="#" class="btn-block" data-toggle="modal" data-target="#Medium-modal" type="button">
                                <img src="{{asset('assets/vendors/images/modal-img2.jpg')}}" alt="modal">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-12 mb-30">
                        <div class="pd-20 card-box height-100-p">
                            ...
                            <a href="#" class="btn-block" data-toggle="modal" data-target="#small-modal" type="button">
                                <img src="{{asset('assets/vendors/images/modal-img3.jpg')}}" alt="modal">
                            </a>
                                        ...
                                        <div class="login-box bg-white box-shadow border-radius-10">
                                            ...
                                            <form>
                                                <div class="select-role">
                                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                        <label class="btn active">
                                                            ...
                                                            <div class="icon"><img src="{{asset('assets/vendors/images/briefcase.svg')}}"
                                                                                   class="svg" alt=""></div>
                                                            <span>I'm</span>
                                                            Manager
                                                        </label>
                                                ...
                                                <div class="row pb-30">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="forgot-password"><a href="/forgot-password">Forgot
                                                                Password</a></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                ...
                                <div class="modal-dialog modal-sm modal-dialog-centered">
                                    <div class="modal-content bg-danger text-white">
                                        <div class="modal-body text-center">
                                            <h3 class="text-white mb-15"><i class="fa fa-exclamation-triangle"></i>
                                                Alert</h3>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                                tempor incididunt ut labore et dolore magna aliqua.</p>
                    ...
                    <div class="col-md-4 col-sm-12 mb-30">
                        <div class="pd-20 card-box height-100-p">
                            ...
                            <a href="#" class="btn-block" data-toggle="modal" data-target="#warning-modal"
                               type="button">
                                <img src="{{asset('assets/vendors/images/modal-img3.jpg')}}" alt="modal">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-12 mb-30">
                        <div class="pd-20 card-box height-100-p">
                            ...
                            <a href="#" class="btn-block" data-toggle="modal" data-target="#confirmation-modal"
                               type="button">
                                <img src="{{asset('assets/vendors/images/modal-img3.jpg')}}" alt="modal">
                            </a>
