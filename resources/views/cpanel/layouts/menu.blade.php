            ...
            <ul id="accordion-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="/welcome2">Dashboard style 2</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle">
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li><a href="/basic-table">Basic Tables</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="/ui-cards-hover">Cards Hover</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="/knob-chart">jQuery Knob</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="/seconnecter">Login</a></li>
                ...
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="/color-settings">Color Settings</a></li>
