                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item active" href="/color-settings">Color Settings</a>
                                <a class="dropdown-item" href="/third-party-plugins">Third Party Plugins</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <p><img src="{{asset('assets/vendors/images/layout/sidebar-dark.png')}}" class="box-shadow" alt=""></p>
                    </div>
                    <div class="col-md-7">
                        <p>Change sidebar color for white add class in <code>body class="sidebar-light"</code></p>
                        <p><img src="{{asset('assets/vendors/images/layout/sidebar-white.png')}}" class="box-shadow" alt=""></p>
                    </div>
                </div>
            </div>
            <div class="pd-20 card-box mb-30">
                ...
                <div class="row">
                    <div class="col-md-12 mb-20">
                        ...
                        <p><img src="{{asset('assets/vendors/images/layout/header-white.png')}}" class="box-shadow" alt=""></p>
                    </div>
                    <div class="col-md-12">
                        <p>Change headedr color for dark add class in <code>body class="header-dark"</code></p>
                        <p><img src="{{asset('assets/vendors/images/layout/header-dark.png')}}" class="box-shadow" alt=""></p>
                    </div>
                </div>
            </div>
            <div class="pd-20 card-box mb-30">
