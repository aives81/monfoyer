        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <div class="pb-20">
                        <button type="button" class="btn btn-primary margin-5" data-toggle="tooltip"
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <p class="pb-20">you can use <code>data-container="body" data-toggle="popover"
                            data-content=""</code></p>
                    <div class="pb-20">
                        <button type="button" class="btn btn-outline-primary margin-5" data-container="body"
