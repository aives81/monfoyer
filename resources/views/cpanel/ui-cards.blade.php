        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="row clearfix">
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                        <div class="card card-box">
                            <img class="card-img-top" src="{{asset('assets/vendors/images/img2.jpg')}}" alt="Card image cap">
                            <div class="card-body">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                        <div class="card card-box">
                            <img class="card-img-top" src="{{asset('assets/vendors/images/img3.jpg')}}" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title weight-500">Card title</h5>
                                <p class="card-text">Some quick example text to build on the card title and make up the
                                    bulk of the card's content.</p>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                        <div class="card card-box">
                            ...
                            <img class="card-img-top" src="{{asset('assets/vendors/images/img1.jpg')}}" alt="Card image cap">
                            <div class="card-body">
                                <p class="card-text">Some quick example text to build on the card title and make up the
                                    bulk of the card's content.</p>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                        <div class="card card-box">
                            <img class="card-img-top" src="{{asset('assets/vendors/images/img4.jpg')}}" alt="Card image cap">
                            <div class="card-body">
                                <p class="card-text">Some quick example text to build on the card title and make up the
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-4 mb-30">
                        <div class="card bg-dark card-box">
                            <img class="card-img" src="{{asset('assets/vendors/images/img1.jpg')}}" alt="Card image">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-4 mb-30">
                        <div class="card card-box">
                            ...
                            <img class="card-img-bottom" src="{{asset('assets/vendors/images/img5.jpg')}}" alt="Card image cap">
                        </div>
                    </div>
                </div>
                <div class="row clearfix">
                ...
                <div class="card-columns mb-30">
                    ...
                    <div class="card card-box">
                        <img class="card-img" src="{{asset('assets/vendors/images/img3.jpg')}}" alt="Card image">
                    </div>
