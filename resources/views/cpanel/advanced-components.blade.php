                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker form-control" data-size="5"
                                            data-style="btn-outline-success" data-selected-text-format="count" multiple>
                                        <option>Mustard</option>
                                        <option>Ketchup</option>
                                        <option>Relish</option>
                                        <option>Plain</option>
                        ...
                        <div class="pd-20 card-box height-100-p">
                            ...
                            <form>
                                <div class="mb-30">
                                    ...
                                    <p>add <code> class="switch-btn" data-color="#0099ff"</code> to your input element.
                                    </p>
                                ...
                                <div class="mb-30">
                                    ...
                                    <p>add <code>data-size="small",data-size="large"</code> to your input element for
                                        diffrent sizes.</p>
                                ...
                                <div class="mb-30">
                                    ...
                                    <p>add <code>data-color="#0099ff" data-secondary-color="#28a745"</code> to your
                                        input</p>
                                    <input type="checkbox" checked class="switch-btn" data-size="small"
                                           data-color="#0099ff" data-secondary-color="#28a745">
                                    ...
                                    <input type="checkbox" class="switch-btn" data-color="#a683eb"
                                           data-secondary-color="#28a745">
                                    <input type="checkbox" checked class="switch-btn" data-size="large"
                                           data-color="#f2a654" data-secondary-color="#28a745">
                        ...
                        <div class="pd-20 card-box height-100-p">
                            ...
                            <form>
                                ...
                                <div class="mb-30">
                                    ...
                                    <p>add <code>data-role="tagsinput"</code> to your select element & use select
                                        multiple</p>
                                ...
                                <div class="mb-30">
                                    ...
                                    <p>add <code>data-role="tagsinput" placeholder="add tags"</code> to your input
                                        element.</p>
